    ...
    private void authentication() throws IOException {
        while (true) {
            ...
            if (message.startsWith(AUTH_CMD_PREFIX)) {
                ...
                this.username = BaseAuthService.getUsernameByLoginAndPassword(login, password);
                System.out.println(BaseAuthService.getUsernameByLoginAndPassword(login, password)); //для теста
                if (username != null) {
